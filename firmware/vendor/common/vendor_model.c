...
#include "../mesh/rd_mesh_data/rd_mesh_data.h"
...
mesh_cmd_sig_func_t mesh_cmd_vd_func[] = {
	...
	#endif
#endif
#if    	(RD_VENDOR_EN)			//RD_EDIT: opcode_vendor
...
//        {RD_OPCODE_RSP_FOR_E2,1,VENDOR_MD_LIGHT_S,VENDOR_MD_LIGHT_C,mesh_cmd_sig_RD_respone_status_type_E3,STATUS_NONE},
//        {RD_OPCODE_TRAINING_TEST2_SEND,0,VENDOR_MD_LIGHT_C,VENDOR_MD_LIGHT_S,RD_Messenger_Training_Test2,STATUS_NONE},
#endif
